...
const heroes = [
        ...
        {
            "id": 76, "name": "Outworld Devourer"
        },
        {
            "id": 77, "name": "Lycanthrope"
        },
        {
...
export default class MyInput extends Component{
    render() {
        return(
            <div>
                <Input {...this.props} list='heroes' placeholder='Hero name...' />
                <datalist id='heroes'>
                    {heroes.map((hero,index) => (<option key={index} value={hero['id']}>{hero['name']}</option>))}
                </datalist>
            </div>
        )
    }
